        ...
        public static void Main()
        {
            ...
            while (!quit)
            {
                ...
                if (typeInt==1) //buy request
                {
                    ...
                    {
                        Console.WriteLine("Invalid ID.Please enter a valid Commodity ID");
                        commodityID = Console.ReadLine();
                    }
                    int commodityNums = Convert.ToInt32(commodityID); //Converting the String to int
                    ...
                    {
                        Console.WriteLine("Invalid amount. Please enter a valid amount(a positive number)");
                        ammount = Console.ReadLine();
                    }
                    int ammountNums = Convert.ToInt32(ammount); 
                    Console.WriteLine("What is the price you want to pay?");
                    String price = Console.ReadLine();
                    while (!isDigitsOnly(price)) 
                    {
                        Console.WriteLine("Your price is invalid. Please enter a valid price");
                        price = Console.ReadLine();
                    }
                    int priceNums = Convert.ToInt32(price); 
                ...
                if (typeInt==2) //sell request
                {
                    ...
                    int commodityNums = Convert.ToInt32(commodityID); 
                ...
                {
                    Console.WriteLine("Please enter the Buy or the Sell Request ID of the request you want to cancel.");
                    String requestID = Console.ReadLine();
                    while (!isDigitsOnly(requestID)) //checking if input is valid
                    {
                        Console.WriteLine("The ID was invalid. Please enter a valid Request ID");
                        requestID = Console.ReadLine();
                    }
                    int requestNums = Convert.ToInt32(requestID); 
                ...
                {
                    Console.WriteLine("What kind of query would you like? Please type the relevant number: 1- Buy/Sell query, 2-User query, 3-Market query.");
                    ...
                    {
                        Console.WriteLine("It seems like your input is invalid, please enter a number between 1 to 3");
                    ...
                    if (queryType.Equals("1")) //query sell/buy
                    {
                        ...
                        if (querySB == null)
                            ...
                            Console.WriteLine(querySB);// implicitly applying  the ToString() method of the object
                    }
                    if (queryType.Equals("2")) //query user
                    {
                        ...
                        if (queryU == null)
                            ...
                            Console.WriteLine(queryU);// implicitly applying  the ToString() method of the object
                    }
                    if (queryType.Equals("3")) //query market
                    {
                        ...
                        if (queryM == null)
                            ...
                            Console.WriteLine(queryM);// implicitly applying  the ToString() method of the object
                    }
                    Console.WriteLine("What would you like to do next? Please type the relevant number: 1-Back to main menu, 0-Quit program");
